...
<section>
    <div class="container">
        ...
        <div class="sect-title text-center wow fadeInUp">
                    <h1 class="title mb-8"><?php echo $lango == 'ar' ? 'المنتجات الأكثر شعبية' : 'Product Best Sellers'; ?></h1>
                    <p class="s-subtitle h6">
                        <?php echo $lango == 'ar' ? 'منتجات الأكثر شعبية وخصم 50%' : 'Up to 50% off Lorem ipsum dolor sit amet, consectetur adipiscing elit'; ?>
                    </p>
                </div>
                ...
                <div class="swiper-slide <?php echo ($slide_count == 1) ? 'swiper-slide-active' : ''; ?>" role="group" aria-label="<?php echo $slide_count; ?> / <?php echo $featured_products->found_posts; ?>"
                    ...
                    <div class="card-product style-5">
                        <div class="card-product_wrapper aspect-ratio-0 d-flex">
                            <a href="<?php echo $product_permalink; ?>" class="product-img" style="max-height: 320px;">
