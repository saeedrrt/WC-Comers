    ...
    <div class="container">
        <div class="sect-title text-center wow fadeInUp animated"
            ...
            <p class="s-subtitle h6">
                <?= $lango == 'ar' ? 'upto 50% off' : 'Up to 50% off Lorem ipsum dolor sit amet, consectetur adipiscing elit'; ?>
            </p>
        </div>
        <div class="tf-grid-layout md-col-2">
            ...
            if ($the_query->have_posts()):
                while ($the_query->have_posts()):
                    ...
                    ?>
                    <div class="box-image_V05 hover-img wow fadeInUp animated"
                        style="visibility: visible; animation-name: fadeInUp;">
...
<?= do_shortcode('[lookbook_bundle id="472"]'); ?>