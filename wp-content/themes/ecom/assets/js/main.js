  ...
  -------------------------------------------------------------------------*/
    ...
    var clickActive = function () {
        ...
        $(".btn-active").on("click", function (event) {
            ...
            if (isResponsive) {
                // ✅ Đóng tất cả các container khác (dù có hay không có .active-1600)
                $(".main-action-active").each(function () {
                    if (this !== $container[0]) {
                        $(this).find(".btn-active, .active-item").removeClass("active");
                    }
  ...
  -------------------------------------------------------------------------*/
    ...
    var customSelect = function () {
        $("select#product_cat").each(function () {
            ...
            var $optionlist = $(
                '<ul class="select-options" /><div class="header-select-option"><span></span><span class="close-option"><i class="icon-close"></i></div>'
