                ...
                <div class="col-md-6">
                    <div class="tf-product-info-wrap position-relative">
                        ...
                        <div class="tf-product-info-list other-image-zoom">
                            ...
                            <!-- Price -->
                            <?php echo display_product_price($product); ?>

                            <!-- Sale Countdown -->
                            <?php echo display_countdown_timer($product); ?>
                        </div>
                        ...
                        <?php
                        $attributes = $product->get_attributes();
                        if (isset($attributes['size']) || isset($attributes['pa_size'])) {
                            $size_attribute = isset($attributes['size']) ? $attributes['size'] : $attributes['pa_size'];

                            if ($size_attribute->is_taxonomy()) {
                                $terms = wc_get_product_terms($product->get_id(), $size_attribute->get_name(), ['fields' => 'names']);
                            } else {
                                $terms = $size_attribute->get_options();
                            }
                                ...
                                <div class="tf-product-variant">
                                    <div class="variant-picker-item variant-size">
                                        <div class="variant-picker-label">
                                            ...
                                            <h3 class="size-guide link h6 fw-medium">
                                        ...
                                        <div class="variant-picker-values">
                                            <?php foreach ($terms as $term): ?>
                                                <span class="size-btn" data-size="<?php echo esc_attr($term); ?>">
                            ...
                            <div class="tf-product-variant">
                                ...
                                if ($product->is_type('variable')) {
                                    ...
                                    foreach ($attributes as $attribute_name => $options) {
                                        ...
                                        ?>
                                        <div class="variant-picker-item variant-<?php echo sanitize_title($attribute_name); ?>">
                                            <div class="variant-picker-label">
                                                <div class="h4 fw-semibold">
                                                    <?php echo $attribute_label; ?>
                                                    <span
                                                        class="variant-picker-label-value value-current<?php echo ucfirst($attribute_name); ?>"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                if (strpos($attribute_name, 'size') !== false) {
                                                    ...
                                                    foreach ($options as $option) {
                                                        ...
                                                        ?>
                                                        <span class="size-btn"
                                                            data-size="<?php echo esc_attr($option); ?>"><?php echo esc_html($option_name); ?></span>
                                                        <?php
                                                    }
                                                } elseif (strpos($attribute_name, 'color') !== false) {
                                                    // Color buttons
                                                    foreach ($options as $option) {
                                                        $term = get_term_by('slug', $option, $attribute_name);
                                                        $option_name = $term ? $term->name : $option;
                                                        ?>
                                                        <div class="hover-tooltip tooltip-bot color-btn"
                                                            data-color="<?php echo esc_attr($option); ?>">
                                                            <span class="check-color"
                                                                style="background-color: <?php echo esc_attr($option); ?>"></span>
                                                            <span class="tooltip"><?php echo esc_html($option_name); ?></span>
                                                        </div>
                                                        <?php
                                                    }
                                                }
                            ...
                            <div class="tf-product-total-quantity">
                                <div class="group-btn">
                                    ...
                                    <div class="wg-quantity">
                                        ...
                                        <?php
                                        // حقل الكمية الافتراضي من WooCommerce
                                    ...
                                    <script>
                                        // ملف js/tf-quantity.js
                                        jQuery(function ($) {

                                            // كل ما يضغط المستخدم + أو -
                                            $('body').on('click', '.btn-quantity', function () {

                                                const $btn = $(this);
                                                const $qty = $btn.closest('.wg-quantity').find('input.qty');
                                                let value = parseFloat($qty.val()) || 0;
